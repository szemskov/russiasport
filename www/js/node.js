...
var node = {
		...
		onGetNode: function(node) {
			...
			$('body').html(
			    '<div id="article"> '+
				    '<div class="header"><div class="three"></div><div class="three centering fullheight"><div class="icon icon-logo"></div></div><div class="three"><a href="javascript:document.location.hash=\'\'; document.location.reload();"><div class="icon icon-reload"></div></a></div></div>'+
